    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.CharField(max_length=32, null=True, verbose_name='Номер')),
                ('expire', models.CharField(max_length=16, null=True, verbose_name='Срок истечения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info', models.CharField(max_length=128, verbose_name='Информация')),
                ('amount', models.IntegerField(verbose_name='Сумма')),
                ('auto_paid', models.BooleanField(default=False, verbose_name='Оплачен автоматический')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Создано')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Обновлено')),
                ('card', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='payment.card', verbose_name='Карта')),
            ],
            options={
                'verbose_name': 'Чек',
